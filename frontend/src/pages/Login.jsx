  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        />
        {/* Only right-side fade to blend into form bg */}
        <div style={{
      ...
      <div style={{
        ...
        {/* Desktop top logo */}
        <div className="desktop-logo" style={{
          display: "none",
          alignItems: "center",
        ...
        <div style={{
          ...
          <div style={{ marginBottom: "32px" }}>
            ...
            <p style={{ color: "#94a3b8", fontSize: "14px" }}>Log in to your account.</p>
          </div>
          ...
          <p style={{ textAlign: "center", color: "#64748b", fontSize: "13px", marginTop: "24px" }}>
            ...
            <Link to="/signup" style={{ color: "#f20d18", fontWeight: "700", textDecoration: "none" }}>
              Register
            </Link>
          </p>
        </div>
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        /* Desktop: show image panel, hide mobile hero */
